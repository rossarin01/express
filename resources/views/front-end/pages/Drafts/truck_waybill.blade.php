...
@section('content')
    ...
    <div>
        <div class="text-right mb-5">
            @livewire('components.assets.button', ['color' => 'secondary', 'title' => 'กลับสู่หน้ารายการ Truck Waybill', 'icon' => 'corner-up-left', 'route' => 'drafts.truckWaybill.index', 'action' => ''])
                        ...
                        <div class="intro-y p-5 flex flex-col justify-center items-center w-full lg:flex">
                            ...
                            <div id="content-to-be-converted"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="6" style="height: 20px; border-top: none;"
                                            data-name="consignor_shipper"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" class="font header "
                                            style="border-bottom: none; padding-bottom: 0; ">Consignee</td>
                                            <td colspan="4" class="font center no-border" style="font-size: 16px;"><strong>TRUCK WAYBILL</strong></td>

                                    </tr>
                                    <tr>
                                        <td colspan="6" style="height: 20px; border-top: none;" data-name="consignee">
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="font header" style="border-bottom: none; padding-bottom: 0; height: 20px;">Notify Party</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" style="height: 25px; border-left: none; font-size: 14px; font-weight: bold;" data-name="invoice_no"></td>
                                    ...
                                    <tr>
                                        <td class="font header" colspan="2"
                                            style="text-align: center; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; text-decoration: underline; width:115px">
                                            Marks and No.</td>
                                        <td class="font header" colspan="2"
                                        ...
                                        <td class="font header" colspan="1"
                                            ...
                                            Gross/Net Weight</td>
                                        <td class="font header" colspan="2"
                                            style="text-align: center; border-right: 1px solid rgb(150, 150, 150); border-bottom: none; text-decoration: underline; width:115px">
                                            Measurements</td>
                                    </tr>

                                    <tr>
                                        <td colspan="2" style="height: 180px; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; border-top: none; text-align: center; line-height: 0.6;" data-name="marks_and_no"></td>

                                        <td colspan="2"
                                            style="height: 180px; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; border-top: none; text-align: center; line-height: 0.6;"
                                            data-name="no_of_packages"></td>
                                        <td colspan="3"
                                            style="height: 180px; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; border-top: none; line-height: 0.6;"
                                            data-name="description_of_goods"></td>
                                        <td colspan="1"
                                            style="height: 180px; border-right: 1px solid rgb(198, 204, 200); border-bottom: none; border-top: none; text-align: center; line-height: 0.6;"
                                            data-name="gross_net_weight"></td>
                                        <td colspan="2"
                                            style="height: 180px; border-left: 1px solid rgb(198, 204, 200); border-bottom: none; border-top: none; text-align: center; line-height: 0.6;"
                                    ...
                                    <tr>
                                        <td colspan="2" style="height: 25px; border-top: none;"
                                            data-name="container_no"></td>
                                        <td colspan="3" style="height: 25px; border-top: none;" data-name="seal_no">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" class="font header"
                                            style="height: 0px; border-bottom: none; padding-bottom: 0;">
                                            Freight Details, Charges, and Etc.
                                        </td>

                                    </tr>
                                    <tr>
                                        <td colspan="5" style="height: 15px; border-top: none;"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="font header" style="border-bottom: none">Authenticated (Signed) for : EXPRESS
                                            INTERTRADE
                                            CO., LTD.</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="5" rowspan="2" class="font center no-border"
                                            ...
                                            By__________________________________________________<br>As Agent(s) for the carrier
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" style="height: 20px; border-top: none;"
                            ...
                            document.querySelectorAll('td[data-name]').forEach(function(td) {
                                td.addEventListener('dblclick', function() {
                                    ...
                                    if (originalName === 'date_of_receipt') {
                                        ...
                                        input.style.lineHeight = '1.0'; // Set line height to reduce space between lines
                                    }
                                    ...
                                    input.addEventListener('blur', function() {
                                        ...
                                        if (input.type === 'date') {
                                            if (input.value) {
                                                ...
                                                newText = `${String(date.getDate()).padStart(2, '0')}/${String(date.getMonth() + 1).padStart(2, '0')}/${date.getFullYear()}`;
                                            } else {
                                                newText = '';
                                            }
                                        } else {
                                            newText = input.value.replace(/\n/g, '<br>').replace(/ {2,}/g, function(spaces) {
                                                return spaces.replace(/ /g, '&nbsp;');
                                            });
                                        }

                                        td.innerHTML = newText;
                                        td.setAttribute('data-name', originalName); // Restore the original data-name attribute
                                        ...
                                        // Apply line-height to the td element
                                        td.style.lineHeight = '0.6';
                                    });
                                });
                            });
                            </script>
