            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        ...
                        <a href="" class="ml-auto flex items-center text-primary">
                            <x-icon name="refresh-ccw" class="w-4 h-4 mr-3"/> Reload Data
                        </a>
                    </div>
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <x-icon name="shopping-cart" class="report-box__icon text-primary"/>
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-success tooltip cursor-pointer" title="33% Higher than last month">
                                                33% <x-icon name="chevron-up" class="w-4 h-4 ml-0.5"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <x-icon name="credit-card" class="report-box__icon text-pending"/>
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="2% Lower than last month">
                                                2% <x-icon name="chevron-down" class="w-4 h-4 ml-0.5"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <x-icon name="monitor" class="report-box__icon text-warning"/>
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-success tooltip cursor-pointer" title="12% Higher than last month">
                                                12% <x-icon name="chevron-up" class="w-4 h-4 ml-0.5"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <x-icon name="user" class="report-box__icon text-success"/>
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-success tooltip cursor-pointer" title="22% Higher than last month">
                                                22% <x-icon name="chevron-up" class="w-4 h-4 ml-0.5"/>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-span-12 lg:col-span-6 mt-8">
                    <div class="intro-y block sm:flex items-center h-10">
                        ...
                        <div class="sm:ml-auto mt-3 sm:mt-0 relative text-slate-500">
                            <x-icon name="calendar" class="w-4 h-4 z-10 absolute my-auto inset-y-0 ml-3 left-0"/>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center">
                            ...
                            <div class="dropdown md:ml-auto mt-5 md:mt-0">
                                <button class="dropdown-toggle btn btn-outline-secondary font-normal" aria-expanded="false" data-tw-toggle="dropdown">
                                    Filter by Category <x-icon name="chevron-down" class="w-4 h-4 ml-2"/>
                                </button>
                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    <div class="intro-y block sm:flex items-center h-10">
                        ...
                        <div class="sm:ml-auto mt-3 sm:mt-0 relative text-slate-500">
                            <x-icon name="map-pin" class="w-4 h-4 z-10 absolute my-auto inset-y-0 ml-3 left-0"/>
                    ...
                    <div class="intro-y block sm:flex items-center h-10">
                        ...
                        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                            <button class="btn box flex items-center text-slate-600 dark:text-slate-300">
                                <x-icon name="file-text" class="hidden sm:block w-4 h-4 mr-2"/> Export to Excel
                            </button>
                            <button class="ml-3 btn box flex items-center text-slate-600 dark:text-slate-300">
                                <x-icon name="file-text" class="hidden sm:block w-4 h-4 mr-2"/> Export to PDF
                            </button>
                        </div>
                    </div>
                                    ...
                                    <tr class="intro-x">
                                        ...
                                        <td class="w-40">
                                            <div class="flex items-center justify-center {{ $faker['true_false'][0] ? 'text-success' : 'text-danger' }}">
                                                <x-icon name="check-square" class="w-4 h-4 mr-2"/> {{ $faker['true_false'][0] ? 'Active' : 'Inactive' }}
                                            </div>
                                        </td>
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-3" href="">
                                                    <x-icon name="check-square" class="w-4 h-4 mr-1"/> Edit
                                                </a>
                                                <a class="flex items-center text-danger" href="">
                                                    <x-icon name="trash-2" class="w-4 h-4 mr-1"/> Delete
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 xl:col-start-1 xl:row-start-2 2xl:col-start-auto 2xl:row-start-auto mt-3">
                        <div class="intro-x flex items-center h-10">
                            ...
                            <a href="" class="ml-auto text-primary truncate flex items-center">
                                <x-icon name="plus" class="w-4 h-4 mr-1"/> Add New Schedules
                            </a>
                        </div>
                        <div class="mt-5">
                            <div class="intro-x box">
                                <div class="p-5">
                                    <div class="flex">
                                        <x-icon name="chevron-left" class="w-5 h-5 text-slate-500"/>
                                        <div class="font-medium text-base mx-auto">April</div>
                                        <x-icon name="chevron-right" class="w-5 h-5 text-slate-500"/>
                                    </div>
