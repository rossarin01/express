            ...
            <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                ...
                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                    <div class="truncate sm:whitespace-normal flex items-center">
                        <x-icon name="mail" class="w-4 h-4 mr-2"/> {{ $fakers[0]['users'][0]['email'] }}
                    </div>
                    <div class="truncate sm:whitespace-normal flex items-center mt-3">
                        <x-icon name="instagram" class="w-4 h-4 mr-2"/> Instagram {{ $fakers[0]['users'][0]['name'] }}
                    </div>
                    <div class="truncate sm:whitespace-normal flex items-center mt-3">
                        <x-icon name="twitter" class="w-4 h-4 mr-2"/> Twitter {{ $fakers[0]['users'][0]['name'] }}
                    </div>
                </div>
            </div>
        ...
        >
            <li id="profile-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <x-icon class="w-4 h-4 mr-2" name="user"/> Profile
                </a>
            </li>
            <li id="account-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <x-icon class="w-4 h-4 mr-2" name="shield"/> Account
                </a>
            </li>
            <li id="change-password-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <x-icon class="w-4 h-4 mr-2" name="lock"/> Change Password
                </a>
            </li>
            <li id="settings-tab" class="nav-item" role="presentation">
                <a
                    ...
                    role="tab"
                >
                    <x-icon class="w-4 h-4 mr-2" name="settings"/> Settings
                </a>
            </li>
        </ul>
    </div>
                                    ...
                                    <div class="w-full lg:w-auto mt-6 lg:mt-0 pt-4 lg:pt-0 flex-1 flex flex-col justify-center items-center lg:items-start px-5 border-t lg:border-t-0 border-slate-200/60 dark:border-darkmode-400">
                                        <div class="flex items-center">
                                            <a href="" class="w-8 h-8 rounded-full flex items-center justify-center border mr-2 text-slate-400">
                                                <x-icon class="w-3 h-3 fill-current" name="facebook"/>
                                            </a>
                                            {{ $faker['users'][0]['email'] }}
                                        </div>
                                        <div class="flex items-center mt-2">
                                            <a href="" class="w-8 h-8 rounded-full flex items-center justify-center border mr-2 text-slate-400">
                                                <x-icon class="w-3 h-3 fill-current" name="twitter"/>
                                            </a>
                                            {{ $faker['users'][0]['name'] }}
                                        </div>
                                    </div>
