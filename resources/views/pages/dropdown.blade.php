                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu w-48">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="" class="dropdown-item">
                                                <x-icon name="edit-2" class="w-4 h-4 mr-2"/> New Dropdown
                                            </a>
                                        </li>
                                        <li>
                                            <a href="" class="dropdown-item">
                                                <x-icon name="trash" class="w-4 h-4 mr-2"/> Delete Dropdown
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="text-center">
                            <div class="dropdown inline-block" data-tw-placement="bottom-start">
                                <button class="dropdown-toggle btn btn-primary" aria-expanded="false" data-tw-toggle="dropdown">
                                    Filter Dropdown <x-icon name="chevron-down" class="w-4 h-4 ml-2"/>
                                </button>
