                                ...
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="javascript:;" class="dropdown-item">
                                            <x-icon name="file" class="w-4 h-4 mr-2"/> Download Excel
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="px-5 text-center sm:text-left">
                            ...
                            <div class="flex flex-col sm:flex-row items-center mt-5">
                                <div class="flex items-center text-slate-500">
                                    <x-icon name="map-pin" class="hidden sm:block w-4 h-4 mr-2"/> 1396 Pooh Bear Lane, New Market
                                </div>
                        ...
                        <div class="dropdown ml-auto">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <x-icon name="settings" class="w-4 h-4 mr-2"/> New Chat
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="dropdown-item">
                        ...
                        <ul class="nav nav-boxed-tabs justify-center flex-col sm:flex-row" role="tablist">
                            <li id="top-products-laravel-tab" class="nav-item" role="presentation">
                                <a
                                    ...
                                    role="tab"
                                >
                                    <x-icon name="box" class="block w-6 h-6 mb-2 mx-auto"/> Laravel
                                </a>
                            </li>
                            <li id="top-products-symfony-tab" class="nav-item" role="presentation">
                                <a
                                    ...
                                    role="tab"
                                >
                                    <x-icon name="inbox" class="block w-6 h-6 mb-2 mx-auto"/> Symfony
                                </a>
                            </li>
                            <li id="top-products-bootstrap-tab" class="nav-item" role="presentation">
                                <a
                                    ...
                                    role="tab"
                                >
                                    <x-icon name="activity" class="block w-6 h-6 mb-2 mx-auto"/> Bootstrap
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <div class="dropdown ml-auto">
                            ...
                            <button class="dropdown-toggle btn btn-outline-secondary font-normal hidden sm:flex" aria-expanded="false" data-tw-toggle="dropdown">
                                Export <x-icon name="chevron-down" class="w-4 h-4 ml-2"/>
                            </button>
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                    ...
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <x-icon name="external-link" class="w-4 h-4 mr-2"/> Excel
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <x-icon name="file-text" class="w-4 h-4 mr-2"/> CSV
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="dropdown-item">
                                            <x-icon name="archive" class="w-4 h-4 mr-2"/> PDF
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <div class="dropdown mt-3 sm:mt-0 mr-auto sm:mr-0">
                                <button class="dropdown-toggle btn btn-outline-secondary font-normal" aria-expanded="false" data-tw-toggle="dropdown">
                                    Filter by Month <x-icon name="chevron-down" class="w-4 h-4 ml-2"/>
                                </button>
                                <div class="dropdown-menu w-40">
