            ...
            <div class="box mt-5">
                <div class="p-5">
                    <a class="flex items-center text-primary font-medium" href="">
                        <x-icon name="activity" class="w-4 h-4 mr-2"/> About Our Products
                    </a>
                    <a class="flex items-center mt-5" href="">
                        <x-icon name="box" class="w-4 h-4 mr-2"/> Related License
                    </a>
                    <a class="flex items-center mt-5" href="">
                        <x-icon name="lock" class="w-4 h-4 mr-2"/> Single Application License
                    </a>
                    <a class="flex items-center mt-5" href="">
                        <x-icon name="settings" class="w-4 h-4 mr-2"/> Multi Application License
                    </a>
                </div>
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <a class="flex items-center" href="">
                        <x-icon name="activity" class="w-4 h-4 mr-2"/> Trem of Use
                    </a>
                    <a class="flex items-center mt-5" href="">
                        <x-icon name="box" class="w-4 h-4 mr-2"/> Author Fees
                    </a>
                    <a class="flex items-center mt-5" href="">
                        <x-icon name="lock" class="w-4 h-4 mr-2"/> Product Review
                    </a>
                    <a class="flex items-center mt-5" href="">
                        <x-icon name="settings" class="w-4 h-4 mr-2"/> Privacy Policy
                    </a>
                </div>
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <a class="flex items-center" href="">
